...
class FHIRPathExpressionParser(Parser):
        ...
        def expression(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    FHIRPathExpressionParser.ExpressionContext
                )
            else:
                return self.getTypedRuleContext(
                    FHIRPathExpressionParser.ExpressionContext, i
                )
    ...
    class InvocationExpressionContext(ExpressionContext):
        ...
        def invocation(self):
            return self.getTypedRuleContext(
                FHIRPathExpressionParser.InvocationContext, 0
            )
    ...
    class TypeExpressionContext(ExpressionContext):
        ...
        def typeSpecifier(self):
            return self.getTypedRuleContext(
                FHIRPathExpressionParser.TypeSpecifierContext, 0
            )
    ...
    def expression(self, _p: int = 0):
        ...
        localctx = FHIRPathExpressionParser.ExpressionContext(
        ...
        try:
            ...
            if token in [
                ...
                FHIRPathExpressionParser.T__3,
                FHIRPathExpressionParser.T__4,
            ]:
                localctx = FHIRPathExpressionParser.PolarityExpressionContext(
                    self, localctx
                )
                self._ctx = localctx
                _prevctx = localctx
                ...
                if not (
                    ...
                    or _la == FHIRPathExpressionParser.T__4
                ):
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = (
                            FHIRPathExpressionParser.MultiplicativeExpressionContext(
                                self,
                                FHIRPathExpressionParser.ExpressionContext(
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << _la)
                                    & (
                                        (1 << FHIRPathExpressionParser.T__5)
                                        | (1 << FHIRPathExpressionParser.T__6)
                                        | (1 << FHIRPathExpressionParser.T__7)
                                        | (1 << FHIRPathExpressionParser.T__8)
                                    )
                                )
                                != 0
                            )
                        ...
                        localctx = FHIRPathExpressionParser.AdditiveExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                            ...
                            (
                                ...
                                and (
                                    ...
                                    & (
                                        ...
                                        | (1 << FHIRPathExpressionParser.T__9)
                                    )
                                )
                                != 0
                            )
                        ...
                        localctx = FHIRPathExpressionParser.UnionExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = FHIRPathExpressionParser.InequalityExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << _la)
                                    & (
                                        (1 << FHIRPathExpressionParser.T__13)
                                        | (1 << FHIRPathExpressionParser.T__14)
                                        | (1 << FHIRPathExpressionParser.T__15)
                                        | (1 << FHIRPathExpressionParser.T__16)
                                    )
                                )
                                != 0
                            )
                        ...
                        localctx = FHIRPathExpressionParser.EqualityExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        if not (
                            (
                                ...
                                and (
                                    (1 << _la)
                                    & (
                                        (1 << FHIRPathExpressionParser.T__17)
                                        | (1 << FHIRPathExpressionParser.T__18)
                                        | (1 << FHIRPathExpressionParser.T__19)
                                        | (1 << FHIRPathExpressionParser.T__20)
                                    )
                                )
                                != 0
                            )
                        ...
                        localctx = FHIRPathExpressionParser.MembershipExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        if not (
                            ...
                            or _la == FHIRPathExpressionParser.T__22
                        ):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                        ...
                        localctx = FHIRPathExpressionParser.AndExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = FHIRPathExpressionParser.OrExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        if not (
                            ...
                            or _la == FHIRPathExpressionParser.T__25
                        ):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                        ...
                        localctx = FHIRPathExpressionParser.ImpliesExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = FHIRPathExpressionParser.InvocationExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = FHIRPathExpressionParser.IndexerExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = FHIRPathExpressionParser.TypeExpressionContext(
                            self,
                            FHIRPathExpressionParser.ExpressionContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        if not (
                            ...
                            or _la == FHIRPathExpressionParser.T__11
                        ):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
    ...
    class ExternalConstantTermContext(TermContext):
        ...
        def externalConstant(self):
            return self.getTypedRuleContext(
                FHIRPathExpressionParser.ExternalConstantContext, 0
            )
    ...
    def literal(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = FHIRPathExpressionParser.BooleanLiteralContext(
                    self, localctx
                )
                self.enterOuterAlt(localctx, 2)
                self.state = 88
                ...
                if not (
                    ...
                    or _la == FHIRPathExpressionParser.T__32
                ):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
    ...
    def invocation(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = FHIRPathExpressionParser.MemberInvocationContext(
                    self, localctx
                )
                self.enterOuterAlt(localctx, 1)
                self.state = 102
                ...
                localctx = FHIRPathExpressionParser.FunctionInvocationContext(
                    self, localctx
                )
                self.enterOuterAlt(localctx, 2)
                self.state = 103
                ...
                localctx = FHIRPathExpressionParser.ThisInvocationContext(
                    self, localctx
                )
                self.enterOuterAlt(localctx, 3)
                self.state = 104
                ...
                localctx = FHIRPathExpressionParser.IndexInvocationContext(
                    self, localctx
                )
                self.enterOuterAlt(localctx, 4)
                self.state = 105
                ...
                localctx = FHIRPathExpressionParser.TotalInvocationContext(
                    self, localctx
                )
                self.enterOuterAlt(localctx, 5)
                self.state = 106
    ...
    class FunctionContext(ParserRuleContext):
        ...
        def paramList(self):
            return self.getTypedRuleContext(
                FHIRPathExpressionParser.ParamListContext, 0
            )
    ...
    class UnitContext(ParserRuleContext):
        ...
        def dateTimePrecision(self):
            return self.getTypedRuleContext(
                FHIRPathExpressionParser.DateTimePrecisionContext, 0
            )

        def pluralDateTimePrecision(self):
            return self.getTypedRuleContext(
                FHIRPathExpressionParser.PluralDateTimePrecisionContext, 0
            )
    ...
    class QualifiedIdentifierContext(ParserRuleContext):
        ...
        def identifier(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    FHIRPathExpressionParser.IdentifierContext
                )
            else:
                return self.getTypedRuleContext(
                    FHIRPathExpressionParser.IdentifierContext, i
                )
