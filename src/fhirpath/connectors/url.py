...
"""Idea has been take from SQLAlchemy
@from: sqlalchemy/engine/url.py
But we modified according to our requirements.
-------------------------------------------------------------------
...
class URL(object):
    ...
    def password(self):
        if self.password_original is None:
            ...
            return force_str(self.password_original)
...
def _parse_rfc1738_args(name):
    ...
    if m is not None:
        ...
        raise Invalid("Could not parse rfc1738 URL from string '{0}'".format(name))
